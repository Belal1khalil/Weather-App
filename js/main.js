...
var weatherData;
 ...
 async function getData(key) {
  let response = await fetch(`https://api.weatherapi.com/v1/forecast.json?key=8ce6c084ae874b1dba8102406241410&q=${key}&days=3`);
...
function tommorrowdata() {
    var date = new Date(weatherData.forecast.forecastday[1].date);
...
function aftertommorrow() {
    var date = new Date(weatherData.forecast.forecastday[2].date);
